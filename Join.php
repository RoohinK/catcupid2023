...
<body>
    <div id="navbar" class="">
        ...
        <b
            style="color: #9A1750; font-family: josefin sans;  font-size: 42px; margin-top: 0.6cm; margin-left: 0.6cm; margin-right:12cm;">CAT
            CUPID</b>
    ...
    <div class="container">
        ...
        <div class="options">
            ...
            <div class="option adopt">
                ...
                <div class="adoptimg"></div><br>
                <a href="https://forms.gle/kYftTgkLafFDj1gz7" id="adoptform"><input type="submit" value="Adopt Now"></a>
            </div>
    ...
    <div class="visit-section dabba">
        ...
        <img src="triplets.jpg" alt="Visit Our Center" class="visit-image">
    ...
    <div id="popup" class="popup">
        <img src="qrcode.jpg" style="width:65%; margin-top: 3%; margin-left: 17%;">
        <br>
    ...
    <script>
        ...
        //To check if the fields are filled or not
        ...
        btn.addEventListener("click", function(event) {
            ...
            if (parentForm && isFormFilled(parentForm)) {
                openPopup();
            } else {
        ...
        // When the close button is clicked, hide the pop-up window
